...
- PPT 封面頁、章節頁、關鍵觀點頁
- 諮詢分析頁、框架頁、方法論頁
- 流程圖、路線圖、矩陣圖、價值鏈、五力模型、2x2 定點陣圖
- 結論頁、建議頁、執行路線頁
- 商業策略、增長、轉型、組織、效率、機會、風險等主題
- 需要“文字主導 + 商業隱喻 + 諮詢報告質感”的視覺型演示
...
```json
{
  ...
  "style_name": "麥肯錫風格",
  "best_for": "商業諮詢型 PPT / PPTX 整套演示，包括封面頁、章節頁、關鍵觀點頁、諮詢分析頁、框架頁、方法論頁、流程圖、路線圖、矩陣圖、價值鏈、五力模型、2x2 定點陣圖、結論頁、建議頁和執行路線頁；適合商業策略、增長、轉型、組織、效率、機會、風險等需要麥肯錫式理性氣質、高階諮詢報告視覺、標題資訊重構、商業隱喻和清晰商業敘事的場景",
  ...
  "layout_blueprints": [
    {
      "name": "PPT 封面頁 / 章節頁: 重構標題 + 單一商業隱喻",
      "sections": [
        {"position": "top", "count": 1, "labels": ["完整標題 / 英文分類標籤 / 年份或編號"]},
        ...
        {"position": "left and right edge", "count": 3, "labels": ["起點詞", "終點詞", "價值詞"]},
        {"position": "optional bottom or side", "count": 1, "labels": ["short takeaway only when useful"]}
      ]
    },
    {
      "name": "PPT 關鍵觀點頁: 字型結構 + 諮詢報告系統",
      "sections": [
